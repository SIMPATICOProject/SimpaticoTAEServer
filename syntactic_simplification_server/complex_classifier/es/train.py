...
from simpatico_ss_es.util import Parser
from simpatico_ss_es.classify import Classify
...
class __main__:
    ...
    def parser_server():
        stfd_parser = Parser("../../../data/stanford-corenlp-full-2016-10-31", "../../../data/spanish.myproperties.properties")
        return stfd_parser
