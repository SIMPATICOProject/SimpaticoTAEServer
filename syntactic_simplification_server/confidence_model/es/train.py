...
class Train:
    ...
    def extract_features(self, dict_dep, sentence, words, model, tool):
        ...
        #matches = tool.check(sentence.decode("latin-1").encode("utf-8"))
...
class __main__:
    ...
    def parser_server():
        stfd_parser = Parser_es("../../../data/stanford-corenlp-full-2016-10-31", "../../../data/spanish.myproperties.properties")
        return stfd_parser
    ...
    model = kenlm.Model('/export/data/cscarton/corpora/training_full.blm.es')

    tool = grammar_check.LanguageTool('es')
