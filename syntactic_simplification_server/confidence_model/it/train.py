...
class __main__:
    ...
    def parser_server():
        stfd_parser = Parser_it("../../../data/stanford-corenlp-full-2016-10-31/", "../../../data/italian.myproperties.properties")
        return stfd_parser
    ...
    model = kenlm.Model('/export/data/cscarton/corpora/training_full.blm.it')

    tool = grammar_check.LanguageTool('it')
