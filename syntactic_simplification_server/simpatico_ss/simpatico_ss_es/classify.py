...
class Classify:
    ...
    def extract_features(self, dict_dep, sentence, words):
        ...
        markers = ("desde", "antes", "sino", "porque", "entonces", "pues", "después", "cuando", "aunque", "pero", "mientras", "si", "o", "y", "que", "quien", "quienes", "cuyo", "cuyos", "cuya", "cuyas")
    ...
    def classify(self, sent, dict_dep, words):
        ...
        clf = joblib.load('../../data/complex_classifier/es/model.pkl')
