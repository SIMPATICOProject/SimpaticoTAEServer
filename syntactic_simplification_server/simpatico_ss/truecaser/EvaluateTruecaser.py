...
def defaultTruecaserEvaluation2(wordCasingLookup, uniDist, backwardBiDist, forwardBiDist, trigramDist):
    testSentences = ["this is a test .", "Harry ate six shrimp At dinner . " , "A letter was Written to me by Rita.", "the hammer has broken The window ."]
...
if __name__ == "__main__":       
    ...
    defaultTruecaserEvaluation2(wordCasingLookup, uniDist, backwardBiDist, forwardBiDist, trigramDist)
