...
sentences = []
for line in open('/export/data/cscarton/corpora/training/all.es'):        
    sentences.append(line.strip())
    
tokens = [nltk.word_tokenize(sentence.decode('utf8', 'ignore')) for sentence in sentences]
...
f = open('distributions.es.obj', 'wb')
